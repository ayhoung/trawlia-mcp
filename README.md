...
| `max_results` | all | Top N of the ranked list. Left out, every result found is returned, typically 20 to 60. These go into your context, so set it when the task is narrow. |
